...
},
{
  ...
  "number": "",
  "title": "Section 3.2",
  "body": " Section 3.2   Problem 3  Let's restate this first to make sure what the claim is. Let be a positive integer. If a prime , implies , then is either prime or a product of two primes.  By way of contradiction, suppose . That is, contains 3 or more prime factors. (Notice , , need not necessarily distinct.) Suppose, without loss of generality, that is the smallest of , , Then we have: So, but     Problem 5  Let be the composite 3 digit number. Suppose all the prime factors are greater than or equal to . The smallest can be is then that is wouldn't be a 3 digit number.    Problem 6  First, notice that since both and are greater than or equal to 1.  Suppose, for example, . If then we'd also have . That is . But this contradicts the construction of and ; divides exactly one of or . Similarly, if we arrive at a contradiction. Hence any prime divisor of is NOT one of the primes . The assumpution there were finitely many primes must be wrong.   "
}
]
