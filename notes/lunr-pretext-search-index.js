...
},
{
  ...
  "number": "",
  "title": "Section 2.3",
  "body": " Section 2.3   Problem 2    If , there exists such that . Then so .    If and then there exist integers such that and . Multiply these two equations: , so .    If then for some integer . Then so . Conversely, if then for some integer . Divide by to obtain , so .     "
}
]
